...
public class back_17387 {
	...
	static boolean isPointInLine(long x1, long y1, long x2, long y2, long x3, long y3)
	{
	...
	static boolean isCCW(long x1, long y1, long x2, long y2, long x3, long y3, long x4, long y4)
	{
		...
		if(isPointInLine(x1,y1,x2,y2,x3,y3) ||
			isPointInLine(x1,y1,x2,y2,x4,y4) ||
			isPointInLine(x3,y3,x4,y4,x1,y1) ||
			isPointInLine(x3,y3,x4,y4,x2,y2))
		{
			return true;
		}
		return false;
